...
public class subtractionScreenActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_subtraction_screen);
        ...
        enter.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    final Toast toast = Toast.makeText(subtractionScreenActivity.this,"Wrong Answer",Toast.LENGTH_SHORT);
                    toast.show();
    ...
    public void verifyUserInput()
    {
        ...
        h.postDelayed(new Runnable() {
            ...
            public void run()
            {
                ...
                if(currentResult == usersAns) {
                    final Toast toast = Toast.makeText(subtractionScreenActivity.this, "Right Answer", Toast.LENGTH_SHORT);
                    toast.show();
                    Handler h = new Handler();
                    h.postDelayed(new Runnable() {
                        @Override
        ...
        builder.setMessage("                    You scored "+score+"/10")
                ...
                .setPositiveButton("OK                                      ", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        startActivity(new Intent(subtractionScreenActivity.this, MainActivity.class));
                        finish();
                    }
                });
        builder.show();
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId())
        {
            case android.R.id.home:
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(subtractionScreenActivity.this);
